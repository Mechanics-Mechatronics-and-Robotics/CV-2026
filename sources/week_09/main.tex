...
\title[CV-2025]{Computer Vision - 2025}
\subtitle{Lecture \#07. Face Recognition}

\author[A.Kornaev, K.Yakovlev]{
  Lectures by Alexei Kornaev \inst{1,2,3,4} \\
  Practical sessions by Kirill Yakovlev \inst{2}
}

\institute[UM]{
  \inst{1} AI Institute, Innopolis University (IU), Innopolis\\
  \inst{2} Robotics \& CV Master's Program, IU, Innopolis \\
  \inst{3} RC for AI, National RC for Oncology, Moscow \\ % n.a. NN.Blokhin
  % \inst{3} Dept. of Mechatronics, Mechanics, and Robotics, Orel State University
  \inst{4} Dept. of \(M^2R\), OSU, Orel
}
...
% % ----Frame------------
% \begin{frame}{Challenges: Pose Variation}
% \scriptsize
% \begin{block}{Problem}
%     Face recognition performance drops when the face is not in a frontal position. Variations in yaw, pitch, and roll angles affect feature extraction.
% \end{block}
% \begin{itemize}
%     \item Profile faces have fewer distinctive features visible.
%     \item Extreme angles can distort facial landmarks.
%     \item Solutions:
%     \begin{itemize}
%         \item Pose normalization using deep learning.
%         \item Multi-view training data.
%     \end{itemize}
% \end{itemize}
% % \begin{figure}
% %     \centering
% %     \includegraphics[width=0.5\textwidth]{figures/pose_variation.png}
% %     \caption{Examples of pose variations in face recognition.}
% % \end{figure}
% \end{frame}
...
% % ----Frame------------
% \begin{frame}[fragile]{Paper reading}
% \scriptsize
% \begin{block}{\href{https://arxiv.org/abs/2004.02980}{LUVLi Face Alignment: Estimating Landmarks' Location, Uncertainty, and Visibility Likelihood}} %
% \tiny
%     Modern face alignment methods have become quite accurate at predicting the locations of facial landmarks, but they do not typically estimate the uncertainty of their predicted locations nor predict whether landmarks are visible. In this paper, we present a novel framework for jointly predicting landmark locations, associated uncertainties of these predicted locations, and landmark visibilities. We model these as mixed random variables and estimate them using a deep network trained with our proposed Location, Uncertainty, and Visibility Likelihood (LUVLi) loss. In addition, we release an entirely new labeling of a large face alignment dataset with over 19,000 face images in a full range of head poses. Each face is manually labeled with the ground-truth locations of 68 landmarks, with the additional information of whether each landmark is unoccluded, self-occluded (due to extreme head poses), or externally occluded. Not only does our joint estimation yield accurate estimates of the uncertainty of predicted landmark locations, but it also yields state-of-the-art estimates for the landmark locations themselves on multiple standard face alignment datasets. Our method's estimates of the uncertainty of predicted landmark locations could be used to automatically identify input images on which face alignment fails, which can be critical for downstream tasks \citet{kumar2020luvli}.
% \end{block}
