...
\setbeamercolor{subtitle}{fg=UMwhite}
...
%% set colors for block statements (no colors)
\setbeamercolor{block title}{fg=black, bg=white} % No background color for block title
\setbeamercolor{block body}{fg=black, bg=white}  % No background color for block body
\setbeamercolor{block title alerted}{fg=black, bg=white} % No background color for alerted block title
\setbeamercolor{block body alerted}{fg=black, bg=white}  % No background color for alerted block body
\setbeamercolor{block title example}{fg=black, bg=white} % No background color for example block title
\setbeamercolor{block body example}{fg=black, bg=white}  % No background color for example block body
...
%% Decrease font size of main text by 3 points
\setbeamerfont{normal text}{size=\small} % \small is approximately 3 points smaller than \normalsize
...
\setbeamertemplate{footline}{
   \begin{beamercolorbox}[ht=0ex,leftskip=1.85cm,rightskip=0.8cm]{UMwhite}
    ...
    \makebox[0pt][l]{\includegraphics[width=15mm]{figures/IULogo.png}} \hfill \textcolor{UMwhite}{\code{UMwhite}}
   \end{beamercolorbox}
   \vspace*{0.2cm}
} 
  ...
  % set the title page design as the background 
  {
    \mode<beamer|handout>{
      \usebackgroundtemplate{
        \includegraphics[width=\paperwidth]{figures/Abbey11.jpg}
      }
    }
    % create title page
    \begin{frame}[plain,t]
